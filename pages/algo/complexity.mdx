...
<div className="bg-surface-blue/30 border-l-[1px] border-primary text-primary text-[16px] p-3">
...
<div className="p-4 my-4 md:p-8 bg-background-2 rounded-md" align="center">
