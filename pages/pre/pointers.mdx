...
![pointer array](/pointers/pointer-array.png)
...
This should be more than enough to understand the basics of pointers. The next part will be about dynamic memory allocation where pointers will sadly return again.
